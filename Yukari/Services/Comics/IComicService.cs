...
namespace Yukari.Services.Comics
{
    public interface IComicService
    {
        ...
        Task<ComicAggregate?> GetComicDetailsAsync(ContentKey ComicKey);
        Task<IReadOnlyList<ChapterAggregate>> GetAllChaptersAsync(ContentKey ComicKey, string language);
